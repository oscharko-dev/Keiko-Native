...
| [`physical-observations.md`](physical-observations.md)           | Sanitized Tauri release-package VoiceOver, IME, appearance, scaling, and restoration observations plus prior Slint context | Release-like package digests and current/supplemental status named in that file; no speech audio or screenshots retained                                    |
...
| [`ADR-0006`](../adr/ADR-0006-tauri-macos-foundation-stack.md)    | Accepted scoped macOS architecture contract and Windows reopen                                                             | Accepted from this evidence set                                                                                                                             |
