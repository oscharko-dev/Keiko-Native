...
const coverageModules = Object.freeze([
  ...
  "epic-merge-adapter.mjs",
  "epic-merge-authorization.mjs",
  "epic-merge-broker.mjs",
  "epic-merge-composition.mjs",
  "epic-merge-evidence.mjs",
  "epic-merge-github.mjs",
  "epic-merge-graphql.mjs",
  "epic-merge-operation.mjs",
  "epic-merge-policy.mjs",
  "epic-merge-policy-schema.mjs",
  "epic-merge-store.mjs",
  "governance-maintainers.mjs",
  "github-api.mjs",
  "github-reference.mjs",
  "issue-contract.mjs",
  "issue-lifecycle.mjs",
  "issue-lifecycle-action.mjs",
  "issue-lifecycle-request.mjs",
  ...
  "lifecycle-coordinator-action.mjs",
  "lifecycle-coordinator.mjs",
  "lifecycle-github-provider.mjs",
  "lifecycle-producer-action.mjs",
  "lifecycle-producer.mjs",
  "lifecycle-producer-wire.mjs",
  "lifecycle-record-auth.mjs",
  "lifecycle-record-budget.mjs",
  "lifecycle-record-canonical.mjs",
  "lifecycle-record-checkpoint.mjs",
  "lifecycle-record-protocol.mjs",
  "lifecycle-record-recovery.mjs",
  "lifecycle-record-schema.mjs",
  "lifecycle-record-store.mjs",
  "lifecycle-record-writer.mjs",
  "lifecycle-wake-locator-writer.mjs",
  "lifecycle-wake.mjs",
  "lifecycle-wakeup-router.mjs",
  "migration-dry-run.mjs",
  "migration-github-provider.mjs",
  "migration-inventory.mjs",
  "migration-orchestrator.mjs",
  "single-file-zip.mjs",
  "merge-group.mjs",
