...
export const SCHEMAS = Object.freeze({
  ...
  "aux:request identity": aux("request identity", [...common, F("exact_target", N(S)), F("generation_identity", SHA), F("attempt", P), F("request_payload_digest", SHA), F("expected_producers", SET(E(...PRODUCERS))), F("predecessor_comment_id", N(P)), F("predecessor_record_digest", N(SHA))]),
  ...
  "aux:fence identity": aux("fence identity", [F("generation_identity", SHA), F("attempt", P), F("phase", E(...PHASES)), F("fence_sequence", P), F("owner_workflow_path", E(COORDINATOR_PATH)), F("owner_run_id", P), F("owner_run_attempt", P), F("source_observation_identity", SHA), F("predecessor_comment_id", N(P)), F("predecessor_record_digest", N(SHA))]),
  "aux:result identity": aux("result identity", [F("expected_producer", E(...PRODUCERS)), F("producer_contract_version", P), F("generation_identity", SHA), F("attempt", P), F("phase_fence_digest", SHA), F("workflow_path", E(PR_CONTRACT_PATH, PUBLICATION_PATH)), F("workflow_id", P), F("workflow_run_id", P), F("workflow_run_attempt", P), F("workflow_job_id", P), F("provider_observation_identity", SHA), F("conclusion", E(...CONCLUSIONS)), F("reason_code", E(...REASON_CODES))]),
  ...
  "aux:effect identity": aux("effect identity", [F("generation_identity", SHA), F("attempt", P), F("phase_fence_digest", SHA), F("source_state", E(...LIFECYCLE_OBSERVATIONS)), F("desired_state", E(...LIFECYCLE_OBSERVATIONS)), F("transition_owner", E(...OWNERS)), F("mutation", E("no-effect", "set-lifecycle", "remove-lifecycle")), F("source_observation_identity", SHA)]),
  "aux:read-back identity": aux("read-back identity", [F("generation_identity", SHA), F("attempt", P), F("phase_fence_digest", SHA), F("effect_identity", N(SHA)), F("observed_state", E(...LIFECYCLE_OBSERVATIONS)), F("issue_updated_at", TIME), F("source_observation_identity", SHA)]),
  ...
  "aux:artifact anchor": aux("artifact anchor", [F("repository", REPO), F("issue_number", P), F("record_type", E(...RECORD_TYPES)), F("record_digest", SHA), F("comment_id", P), F("comment_body_sha256", SHA), F("generation_identity", SHA), F("attempt", P), F("workflow_path", E(...WRITERS)), F("workflow_run_id", P), F("workflow_run_attempt", P), F("protected_dev_sha", OID)]),
});
