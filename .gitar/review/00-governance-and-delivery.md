...
Treat every pull request targeting `dev` as a potentially large native integration. Verify the
...
Reject direct `dev` pushes, force pushes, gate bypasses, authority widening, unsigned delivery,
